...
export const useBarcodeReader = (
  ...
  const [scannedBarcode, setScannedBarcode] = useState<CodeDetection[] | null>(
    null
  );
                  ...
                  try {
                    ...
                    if (result && result.location) {
                      detection.points = [
                        ...
                        {
                          x: result.location.topRightCorner.x,
                          y: result.location.topRightCorner.y,
                        },
                        {
                          x: result.location.bottomRightCorner.x,
                          y: result.location.bottomRightCorner.y,
                        },
                        {
                          x: result.location.bottomLeftCorner.x,
                          y: result.location.bottomLeftCorner.y,
                        },
                      ];
                    }
                  } catch (e) {
                    console.debug(
                      "Could not extract corner points from barcode"
                    );
                  }
